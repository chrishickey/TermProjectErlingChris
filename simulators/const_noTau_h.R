...
# Write out data
write.table(all_data, file = "simul_data_2_const_h_noT.txt", row.names = F, col.names = T, sep = "\t")
# write out parameters
write.table(simul_pars[-c(14),], file ="simul_param_2_const_h_noT.txt", row.names=F, col.names = T, sep = "\t")
write.table(
            data.frame(
              RiskAversion = 0.5,
            ...
            file ="simul_param_hyp_2_const_h_noT.txt", row.names=F, col.names = T, sep = "\t")
